...
try {
    echo "Testing sendWhatsAppTemplateV2 mutation with return type SendTemplateResult...\n";
    $result = $whatsappResolver->sendWhatsAppTemplateV2($input, $context);
    
    echo "Result is an instance of SendTemplateResult: " . (($result instanceof SendTemplateResult) ? "Yes" : "No") . "\n";
    echo "Success: " . ($result->success() ? "Yes" : "No") . "\n";
    echo "MessageId: " . ($result->messageId() ?? "null") . "\n";
