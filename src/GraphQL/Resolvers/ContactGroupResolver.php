...
class ContactGroupResolver
{
    ...
    public function resolveContactGroupsCount(array $args, $context): int
    {
        ...
        try {
            ...
            $count = $this->contactGroupRepository->countByUserId($userId);
    ...
    public function mutateCreateContactGroup(array $args, $context): array
    {
        ...
        try {
            ...
            $savedGroup = $this->contactGroupRepository->save($group);
    ...
    public function mutateUpdateContactGroup(array $args, $context): array
    {
        ...
        try {
            ...
            $savedGroup = $this->contactGroupRepository->save($existingGroup);
    ...
    public function mutateAddContactToGroup(array $args, $context): array
    {
        ...
        try {
            ...
            if (!$savedMembership) {
                throw new Exception("Failed to retrieve membership after adding contact to group");
            }
    ...
    public function mutateRemoveContactFromGroup(array $args, $context): bool
    {
        ...
        try {
            ...
            $deleted = $this->membershipRepository->removeContactFromGroup($contactId, $groupId);
            if ($deleted) {
            ...
            try {
                foreach ($contactIds as $contactId) {
                    ...
                    try {
                        ...
                        if ($success) {
                            // Get the membership
                            $membershipList = $this->membershipRepository->findByContactId($contactId);
                            $savedMembership = null;
                            foreach ($membershipList as $m) {
                                if ($m->getGroupId() === $groupId) {
                                    $savedMembership = $m;
                                    break;
                                }
                            ...
                            if ($savedMembership) {
                                ...
                                $errors[] = [
                                    'contactId' => $contactId,
                                    'message' => 'Failed to retrieve membership after adding contact to group'
                                ];
                            }
                        } else {
                            $failed++;
